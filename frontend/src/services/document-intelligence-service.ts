...
export interface SupplierMatching { supplier_id?: number; supplier_name?: string; confidence?: number; method?: string; decision?: string; }
export interface ProductSuggestion { product_id: number; product_name: string; supplier_id?: number; supplier_name?: string; confidence?: number; method?: string; decision?: string; }\nexport interface ExtractedItem { supplier_sku?: string; barcode?: string; description?: string; quantity?: number; unit?: string; package_quantity?: number; unit_price?: number; discount?: number; tax?: number; page_number?: number; supplier_section_index?: number; supplier_context?: { name?: string; customer_number?: string }; supplier_matching?: SupplierMatching | null; product_matching?: { decision?: string; best_match?: ProductSuggestion; suggestions?: ProductSuggestion[] }; }
...
export interface ExtractedData { document_type?: string; supplier?: { name?: string; customer_number?: string }; supplier_sections?: SupplierSection[]; supplier_count?: number; document_number?: string; document_date?: string; currency?: string; totals?: { subtotal?: number; tax?: number; total?: number }; items?: ExtractedItem[]; applied_line_indexes?: number[]; processing?: ProcessingProgress; page_count?: number; pages_processed?: number; extraction_mode?: string; supplier_matching?: SupplierMatching | SupplierMatching[] | null; matching_version?: string; }
