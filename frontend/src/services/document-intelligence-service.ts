...
export interface ExtractedItem { supplier_sku?: string; barcode?: string; description?: string; quantity?: number; unit?: string; package_quantity?: number; unit_price?: number; discount?: number; tax?: number; page_number?: number; supplier_section_index?: number; supplier_context?: { name?: string; customer_number?: string }; supplier_matching?: SupplierMatching | null; product_matching?: { decision?: string; best_match?: { product_id?: number; product_name?: string; supplier_id?: number; supplier_name?: string; confidence?: number; method?: string; decision?: string }; suggestions?: Array<Record<string, unknown>> }; }
