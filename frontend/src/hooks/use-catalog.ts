...
/**
 * Explicit-id product update mutation.
 * Prefer this for row actions or flows where the target product can change
 * between render cycles. The id travels with the mutation itself.
 */
