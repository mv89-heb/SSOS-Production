...
export default function DocumentIntelligencePage() {
  ...
  async function apply() {
    ...
    if (lines.some((line) => !line.product_id || !line.supplier_id)) { setError("יש לאשר התאמת מוצר וספק רק בשורות שלא זוהו בוודאות גבוהה."); return; }
