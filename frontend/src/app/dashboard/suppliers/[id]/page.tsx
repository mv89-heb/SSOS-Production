...
export default function SupplierDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (isError || !supplier) return <p className="text-sm text-slate-400">Supplier not found</p>;
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base text-slate-900">Products from this supplier</CardTitle>
        </CardHeader>
        <CardContent className="pt-0">
