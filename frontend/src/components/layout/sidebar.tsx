...
export default function Sidebar() {
  ...
  return (
    <aside
      dir="rtl"
      className="sticky right-0 top-0 z-30 hidden h-screen w-64 shrink-0 flex-col border-s border-slate-200/80 bg-white/95 backdrop-blur-md dark:border-slate-800 dark:bg-slate-950/95 md:flex"
        ...
        {items.map((item) => {
          ...
          return (
            ...
            >
              ...
              {isActive && <ChevronRight className="h-4 w-4 opacity-70" aria-hidden="true" />}
            </Link>
          );
        })}
      </nav>
