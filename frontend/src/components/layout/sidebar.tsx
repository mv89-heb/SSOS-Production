...
export default function Sidebar() {
  ...
  return (
    <aside dir="rtl" className="fixed right-0 top-0 z-[100] hidden h-dvh w-64 flex-col border-s border-slate-200 bg-white shadow-xl dark:border-slate-800 dark:bg-slate-950 md:flex" aria-label="תפריט ניווט ראשי">
      <div className="flex min-h-24 shrink-0 items-center gap-3 border-b border-slate-100 px-5 dark:border-slate-800">
        ...
        <div className="min-w-0"><div className="truncate text-[15px] font-black leading-5 text-slate-950 dark:text-white">ישיבת אוהבי ירושלים</div><div className="truncate text-xs font-bold text-indigo-600 dark:text-indigo-300">ראשית</div></div>
      </div>
