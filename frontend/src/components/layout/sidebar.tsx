...
export default function Sidebar() {
  ...
  return (
    <aside dir="rtl" className="fixed inset-y-0 right-0 z-50 hidden w-64 shrink-0 flex-col border-s border-slate-200/80 bg-white/95 shadow-sm backdrop-blur-md md:flex dark:border-slate-800 dark:bg-slate-950/95" aria-label="תפריט ניווט ראשי">
      <div className="flex min-h-24 shrink-0 items-center gap-3 border-b border-slate-100 px-5 dark:border-slate-800"><div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-indigo-700 to-violet-700 text-lg font-black text-white shadow-lg shadow-indigo-700/20">ר</div><div className="min-w-0"><div className="truncate text-[15px] font-black leading-5 text-slate-950 dark:text-white">ישיבת אוהבי ירושלים</div><div className="truncate text-xs font-bold text-indigo-600 dark:text-indigo-300">ראשית</div></div></div>
