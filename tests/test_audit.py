def test_actions_generate_audit_entries(logged_in_client_a, make_order):
...
def test_audit_chain_verifies_as_valid(logged_in_client_a, make_order):
    make_order(logged_in_client_a, supplier_name="Supplier X")
    make_order(logged_in_client_a, supplier_name="Supplier Y")
...
def test_audit_entries_are_hash_chained(logged_in_client_a, make_order):
    make_order(logged_in_client_a, supplier_name="Supplier X")
...
def test_tampering_audit_log_breaks_verification(app, logged_in_client_a, db, make_order):
