...
class PriceObservation(db.Model):
    ...
    def to_dict(self):
        return {"id": self.id, "product_id": self.product_id, "supplier_id": self.supplier_id,
                "supplier_name": self.supplier.name if self.supplier else None,
                "source_document_id": self.source_document_id, "observed_price": float(self.observed_price),
                ...
                "comparison_unit": self.comparison_unit, "price_basis": self.price_basis,
                "source_type": self.source_type, "match_method": self.match_method,
