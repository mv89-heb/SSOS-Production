...
# is intentional: specific product phrases must win over generic words such
# as "בצל", "פלפל", "קפה" or "שוקו" that can appear inside preparations.
HARD_RULES = (
    ("משקאות", (
        "אבקה להכנת אייס קפה", "אבקה להכנת שוקו", "אבקת שוקו",
        "אבקה להכנת קפה", "אבקת קפה נמס",
    )),
    ("ממתקים", (
        "אבקת נוגט", "אבקת שוקולד", "אבקת קקאו מתוקה",
    )),
    ("מזון יבש", (
        "אבקת בצל", "אבקת אפיה", "אבקת אפייה", "אבקה להכנת פירה",
        "אבקה להכנת טמפורה", "אבקת מרק", "אבקת שום", "אבקת קקאו",
    )),
...
EXCLUSIONS = {
    "ירקות": (
        "פלפל שחור", "פלפל לבן", "פלפל גרוס", "פלפל אדום טחון",
        "אבקת בצל", "אבקת שום", "אבקת מרק", "אבקת אפיה", "אבקת אפייה",
        "אבקה להכנת פירה", "אבקה להכנת טמפורה",
    ),
