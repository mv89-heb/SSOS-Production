...
PRIORITY_RULES = [
    ...
    ("שימורים", (
        "טונה בשימורים", "טונה בקופסה", "טונה משומרת", "תירס בקופסה",
        "תירס משומר", "שעועית שימורים", "קופסת שימורים", "קופסאות שימורים",
        "שימורים", "שימור", "זיתים", "זית", "חמוצים", "חמוץ",
    )),
    ("חד פעמי", (
    ...
    ("רטבים ותבלינים", (
        "פלפל שחור", "פלפל לבן", "פלפל גרוס", "פלפל אדום טחון", "פפריקה",
        "כמון", "כורכום", "מלח", "תבלין", "תבלינים", "קטשופ", "מיונז",
        "חרדל", "רוטב", "רטבים", "רוטב סויה", "שום כתוש", "טחינה", "חומוס",
    )),
    ("עוף", (
        "שניצל עוף", "חזה עוף", "כרעיים", "כנפי עוף", "כנפיים", "פרגית", "פרגיות",
        "נאגטס עוף", "פסטרמה עוף", "עוף", "עופות",
    )),
    ("בשר", (
        "בשר טחון", "טחון בקר", "אסאדו", "צלי בקר", "סטייק", "סינטה", "אנטריקוט",
        "המבורגר בקר", "קבב", "קבבים", "קציצה", "קציצות", "בשר", "בשרים",
    )),
    ("דגים", (
        "פילה דג", "פילה סלמון", "סלמון", "אמנון", "מושט", "קרפיון", "סרדין",
        "סרדינים", "דג", "דגים", "טונה",
    )),
    ("מוצרי חלב", (
        "מוצרי חלב", "מוצר חלב", "גבינת", "גבינה", "גבינות", "קוטג", "יוגורט",
        "יוגורטים", "שמנת", "לבנה", "מעדן", "מעדנים", "חמאה", "אשל", "ריוויון",
        "חלב",
    )),
    ("ירקות", (
        "תפוחי אדמה", "תפוח אדמה", "תפו אדמה", "עגבניות", "עגבניה", "מלפפונים",
        "מלפפון", "גזרים", "גזר", "בצל", "בצלים", "פלפלים", "פלפל אדום",
        "פלפל ירוק", "כרוב", "כרובים", "חסה", "קישוא", "קישואים", "ברוקולי",
        "כרובית", "סלק", "צנונית", "בטטה", "בטטות", "חציל", "חצילים", "ירקות",
        "ירק",
    )),
    ("פירות", (
        "תפוחים", "תפוח", "בננות", "בננה", "תפוזים", "תפוז", "קלמנטינות",
        "קלמנטינה", "אגסים", "אגס", "ענבים", "אבטיח", "מלון", "אפרסקים", "אפרסק",
        "שזיפים", "שזיף", "מנגו", "קיווי", "אננס", "פירות", "פרי",
    )),
    ("מזון יבש", (
        "דגני בוקר", "קורנפלקס", "שיבולת שועל", "אורז", "פסטה", "ספגטי", "קוסקוס",
        "קמח", "סוכר", "קטניות", "עדשים", "בורגול", "פתיתים", "גריסים", "מזון יבש",
    )),
    ("מאפים ולחמים", (
    ...
    ("משקאות", (
        "מים מינרליים", "מיץ תפוזים", "מיץ", "מיצים", "מים", "סודה", "קולה",
        "שתיה", "שתייה", "משקה", "משקאות", "קפה נמס", "קפה", "תה", "שוקו",
    )),
    ("חטיפים", (
    ...
    ("ממתקים", (
        ...
        "וופלים", "מרשמלו", "סוכריות גומי", "גומי", "טופי",
    )),
    ("ניקיון", (
        "אקונומיקה", "נוזל כלים", "סבון כלים", "אבקת כביסה", "מרכך כביסה", "מרכך",
        "מסיר שומנים", "שקיות אשפה", "שקית אשפה", "מטליות", "נייר ניקוי", "ניקוי",
        "ניקיון", "סבון",
    )),
    ("ציוד מטבח", (
        "קרש חיתוך", "כלי מטבח", "תבנית", "קערה", "קערות", "מלקחיים", "פותחן",
        "כף הגשה", "מחבת", "סיר", "סכין", "צלחות", "צלחת", "כוס", "כוסות",
        "ציוד מטבח",
    )),
]
