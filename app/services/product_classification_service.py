...
class ProductClassificationService:
    ...
    def classify(self, tenant_id: int, product_name: str):
        ...
        # Exact user corrections have priority over generic rules. Query the
        # exact normalized name directly so learning remains correct even when
        # a tenant has more than 2,000 feedback records.
        ...
        if not scores:
            return {
                ...
                "confidence": 0.15,
                "source": "RULES",
                "reason": "לא נמצאה התאמה לחוקי הסיווג",
            }
