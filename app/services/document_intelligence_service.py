        ...
        try:
            for item in lines:
                ...
                intelligence.record_observation(
                    product_id=product_id, supplier_id=supplier_id, observed_price=price_value,
                ...
                intelligence.accept_price_change(
                    product_id=product_id, supplier_id=supplier_id, new_price=price_value,
                    currency=currency, unit=item.get("unit"), source_type=row.document_type or "OTHER",
                ...
                if supplier_id == product.supplier_id:
                    ...
                    if offer is None:
                        offer = SupplierProductOffer(
                            tenant_id=self.tenant_id, product_id=product_id, supplier_id=supplier_id,
                            price=price_value, currency=currency, unit=item.get("unit"), active=True,
                        )
