...
class ProductionConfig(BaseConfig):
    ...
    def init_app(app):
        ...
        app.config["GEMINI_MODEL"] = os.environ.get("GEMINI_MODEL", "gemini-3.5-flash-lite").strip()
        app.config["GEMINI_THINKING_LEVEL"] = os.environ.get("GEMINI_THINKING_LEVEL", "low").strip()
